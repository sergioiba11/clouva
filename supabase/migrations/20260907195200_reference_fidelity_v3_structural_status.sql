...
alter table public.vip_profile_generation_jobs
  ...
  check (status = any (array[
    ...
    'rendering_reference_preview','capturing_reference_render','comparing_reference',
    'applying_visual_corrections','regenerating_structure','validating_visual_fidelity',
    'awaiting_variant_selection','review_ready','published','failed','blocked_budget',
