...
with tempfile.TemporaryDirectory() as temp:
    ...
    assert result["clearance"]["available"] is True
    ...
    assert result["readiness"]["collision_review_ready"] is True
    assert result["readiness"]["production_pattern_ready"] is True
