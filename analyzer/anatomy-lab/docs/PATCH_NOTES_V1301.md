# CLOUVA Anatomy Lab v1.3.0.1 — Garment Analysis Workspace
...
- Hotfix de instalación: reemplaza el smoke geométrico sintético por validación segura de rutas y contratos.
