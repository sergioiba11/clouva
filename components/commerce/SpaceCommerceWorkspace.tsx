...
import { Facebook, Megaphone } from "lucide-react";
    ...
    <div className={styles.workspace} data-space-commerce-workspace>
      <header className={styles.clouvaBar} aria-label="CLOUVA · Centro Operativo">
        ...
        <div className="flex items-center gap-2">
          {businessSpaceId ? <Link href={`/businesses/${businessSpaceId}/publicador`} className="inline-flex items-center gap-2 rounded-xl border border-blue-400/20 bg-blue-500/[0.06] px-3 py-2 text-xs font-semibold text-blue-100 transition hover:border-blue-400/35"><Facebook size={14} /> Publicador Facebook</Link> : null}
