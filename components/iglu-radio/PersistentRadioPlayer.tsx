...
function statusLabel(status: ReturnType<typeof useIgluRadio>["status"]) {
  switch (status) {
...
export function PersistentRadioPlayer() {
  ...
  return (
    <>
      <section className="iglu-radio-player" aria-label="Reproductor IGLÚ RADIO">
        ...
        <div className="iglu-radio-player__center">
          <button
            ...
            aria-label={radio.isPlaying ? "Pausar IGLÚ RADIO" : radio.status === "ERROR" ? "Reintentar IGLÚ RADIO" : "Reproducir IGLÚ RADIO"}
          >
        ...
        <div className="iglu-radio-player__controls">
          ...
          <input
            aria-label="Volumen de IGLÚ RADIO"
            type="range"
            min="0"
            max="1"
            step="0.01"
      ...
      {radio.expanded ? (
        <div className="iglu-radio-expanded" role="dialog" aria-modal="true" aria-label="IGLÚ RADIO">
