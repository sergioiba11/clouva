...
export async function generateLayoutConfig(args: {
  ...
  const promptText = [
    ...
    '  "sections": [ { "type": string, "variant": string, "headline": string, "subheadline": string, "primaryLabel": string, "primaryIcon": string, "secondaryLabel": string, "secondaryIcon": string, "heading": string, "body": string, "items": [{"title": string, "description": string}] } ],',
