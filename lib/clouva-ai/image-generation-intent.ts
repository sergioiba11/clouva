...
const CREATE_VERBS = /\b(generame|generá|genera|generar|creame|creá|crea|crear|haceme|hacé|hace|hacer|diseñame|diseñá|diseña|armame|armá|arma|convertime|convertí|converti|pasame|pasá|pasa)\b/i;
const REFERENTIAL_CREATE = /\b(hacelo|hacela|hacerlo|hacerla|generalo|generala|crealo|creala|armalo|armala|pasalo|pasala|convertirlo|convertirla)\b/i;
