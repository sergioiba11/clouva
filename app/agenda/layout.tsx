  ...
  return (
    <>
      ...
      <nav className="fixed bottom-3 left-1/2 z-40 flex -translate-x-1/2 items-center gap-1 rounded-2xl border border-white/10 bg-[#101017]/90 p-1.5 shadow-2xl backdrop-blur-xl md:bottom-auto md:left-auto md:right-5 md:top-5 md:translate-x-0">
        ...
        <Link href="/agenda/lunar" className="inline-flex items-center gap-2 rounded-xl px-3 py-2 text-xs font-medium text-white/65 transition hover:bg-white/[0.07] hover:text-white"><MoonStar size={14} /><span className="hidden sm:inline">Luna</span></Link>
