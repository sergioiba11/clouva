...
type ReserveAccountRef = { id: string; name: string; provider: string; accountType: string; currency: string; status: string; isActive: boolean } | null;
...
function activeBacking(asset: FlowAsset) {
  ...
  return Boolean(allocation && allocation.status === "active" && allocation.reserveAccount?.isActive && allocation.reserveAccount.status === "active");
}
