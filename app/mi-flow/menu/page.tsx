  ...
  return (
    <main className="min-h-screen bg-[#050505] px-4 pb-28 pt-8 text-white sm:px-8">
      ...
      <div className="mx-auto mt-4 max-w-3xl rounded-2xl border border-white/8 bg-white/[0.025] p-4 text-xs leading-5 text-white/45">
        MI FLOW es tu billetera y centro económico. MI SPOT es tu negocio. Centro creativo conserva tus herramientas de creación.
      </div>
      <div className="mx-auto mt-5 grid max-w-3xl grid-cols-2 gap-3 sm:grid-cols-3">
        ...
        <Link href="/tienda" className="os-card flex min-w-[9.5rem] flex-col gap-3 border-l-2 border-l-[#8f7cff]/50 p-4"><p className="font-medium">Tienda</p></Link>
        <Link href="/perfil" className="os-card flex min-w-[9.5rem] flex-col gap-3 border-l-2 border-l-[#8f7cff]/50 p-4"><p className="font-medium">Perfil</p></Link>
      </div>
      <nav className="fixed bottom-3 left-1/2 z-20 flex w-[88%] max-w-xs -translate-x-1/2 items-center justify-around rounded-2xl border border-white/10 bg-black/70 p-2 backdrop-blur">
        <Link href="/" className="flex flex-col items-center gap-1 px-6 py-1 text-[10px] text-white/70"><span className="text-xl leading-none">🏠</span>Home</Link>
