          ...
          <section className="relative mt-5 overflow-hidden rounded-[30px] border bg-[#0d0a13] p-6 sm:p-8" style={{ borderColor: `${accent}38` }}>
            ...
            <div className="relative flex flex-col justify-between gap-6 md:flex-row md:items-end">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {canBusiness ? <Link href={`/mi-spot/${spotId}/scanner`} className="inline-flex items-center gap-2 rounded-xl border border-cyan-300/25 bg-cyan-400/[0.08] px-4 py-2.5 text-sm font-semibold text-cyan-100"><ScanLine size={16} /> Scanner</Link> : null}
